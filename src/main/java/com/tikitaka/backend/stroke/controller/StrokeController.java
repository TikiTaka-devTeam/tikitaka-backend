...
public class StrokeController {
    ...
    public ResponseEntity<SaveStrokesResponse> savePrivateStrokes(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(strokeService.savePrivateStrokes(slideId, userId, request));
    }
    ...
    public ResponseEntity<GetPrivateStrokesResponse> getPrivateStrokes(
        ...
        UUID userId = extractUserId(authHeader);
        return ResponseEntity.ok(strokeService.getPrivateStrokes(slideId, userId));
    }
    ...
    public ResponseEntity<DeleteStrokeResponse> deletePrivateStroke(
        ...
        UUID userId = extractUserId(authHeader);
        return ResponseEntity.ok(strokeService.deletePrivateStroke(strokeId, userId));
    }
    ...
    public ResponseEntity<SaveStrokesResponse> saveSharedStrokes(
        ...
        UUID userId = extractUserId(authHeader);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(strokeService.saveSharedStrokes(slideId, userId, request));
    }
    ...
    public ResponseEntity<GetSharedStrokesResponse> getSharedStrokes(
        ...
        UUID userId = extractUserId(authHeader);
        return ResponseEntity.ok(strokeService.getSharedStrokes(slideId, userId));
    }
    ...
    public ResponseEntity<DeleteStrokeResponse> deleteSharedStroke(
        ...
        UUID userId = extractUserId(authHeader);
        return ResponseEntity.ok(strokeService.deleteSharedStroke(strokeId, userId));
    }
